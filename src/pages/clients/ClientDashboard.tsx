...
export default function ClientDashboard() {
    ...
    return (
        <Container maxWidth="lg">
            ...
            <Button variant="contained" size="large" color="error" sx={{color: "white", borderColor: "black", textTransform: "none", fontWeight: 600, my: 2}} onClick={() => { handleLogout(); navigate("/login"); }}>Logout</Button>
        </Container>
    );
}